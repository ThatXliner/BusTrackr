...
The scenery is an authored approximation, with original detailed bus models and reference-informed campus landmarks. It is not photogrammetry. Bus positions and ETAs are simulated. Real GPS, school-verified routing, native packaging, accessibility review and physical-phone profiling are later production work. Six roadside building envelopes use documented inferred height corrections to clear sampled uphill ground; aerial textures blur close to the ground, and transparent glazing uses a simplified material. See `docs/performance.md` for measured preview results and limitations.
